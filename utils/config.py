...
parser.add_argument('-ds', '--dataset', help='dataset, kvr or cam', required=False, default='kvr')
parser.add_argument('-t', '--task', help='Task Number', required=False, default='')
parser.add_argument('-dec', '--decoder', help='decoder model', required=False, default='GLMP')
